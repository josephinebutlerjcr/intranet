...
module.exports = {
    ...
    execute: async(event, verification) => {
        ...
        try {
            ...
            failure.push("Internal server error when uploading. Please contact the webmaster (<a href=\"mailto:webmaster@butlerjcr.com\">webmaster@butlerjcr.com</a>) if this error persists.");
            update = false;
        }
