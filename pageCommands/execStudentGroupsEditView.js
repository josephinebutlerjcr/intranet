    ...
    execute: async(event, verification) => {
        ...
        <section style="display: flex; justify-content: center;">
            <section class="latest-news" style="padding: 3rem 1rem; max-width: 600px; text-align: left;">
                ...
                <p>You can not change the internal ID, ${society.id}. If you wish to do so, please contact the webmaster (<a href=\"mailto:webmaster@butlerjcr.com\">webmaster@butlerjcr.com</a>) (the request may only be granted if it makes sense to do so).</p>
