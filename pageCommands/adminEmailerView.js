...
module.exports = {
  ...
  <div style="font-family: 'Times New Roman', Times, serif; border: 1px solid black; padding: 16px; border-radius: 8px;">
    ...
    <p>
      If you have any problems, please contact the webmaster at <a href="mailto:webmaster@butlerjcr.com">webmaster@butlerjcr.com</a> - or alternatively the JCR President at 
