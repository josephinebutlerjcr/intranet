...
module.exports = {
    ...
    execute: async(event, verification) => {
        ...
        let content = `<p>Sorry, you must ask the webmaster to do so manually as this is still a work in progress - to edit information, or as an override to add someone new. <a href="/exec">Click here</a> to go back.</p>`
