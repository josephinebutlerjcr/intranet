...
module.exports = {
    ...
    execute: async(event, verification) => {
        ...
        <p>Note: you can not edit anything except the contents of the article. If you want to, contact the webmaster (<a href=\"mailto:webmaster@butlerjcr.com\">webmaster@butlerjcr.com</a>).</p>
        <p>
